...
public class personAdapter extends FirebaseRecyclerAdapter<
                     ...
                     int position, @NonNull person model)
    {
        ...
        holder.firstname.setText(model.getnomDactivite());

        // Add lastname from model class (here
        // "person.class")to appropriate view in Card
        // view (here "person.xml")
        holder.lastname.setText(model.getactivityStatuts());

        // Add age from model class (here
        // "person.class")to appropriate view in Card
        // view (here "person.xml")
        holder.age.setText(model.getdateActivite());
    }
                       ...
                       int viewType)
    {
        View view
                ...
                .inflate(R.layout.user_created_activities, parent, false);
